...
### 2. Describe three different ways functions can be stored/applied and an example of when you might want to use each version. (Ash/Cam)
...
mtcars %>%
 mutate(mean = sum(mtcars$mpg)/length(mtcars$mpg))
